...
setup(windows = ["play.py"],
      ...
      data_files=[("maps", ["maps/caves.map", "maps/central.map", "maps/east.map", "maps/northcave.map"]),
                  ("sounds", ["sounds/door.wav", "sounds/footstep.wav", "sounds/lifelost.wav", "sounds/pickup.wav", "sounds/swoosh.wav", "sounds/wasp.wav", "sounds/beetle.wav", "sounds/endgame.wav"]),
